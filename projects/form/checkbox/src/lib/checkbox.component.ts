...
/**
 * Provider Expression that allows ls-checkbox to register as a ControlValueAccessor.
...
/** Change event object emitted by LsCheckbox. */
export class LsCheckboxChange {
  /** The source LsCheckbox of the event. */
  source: LsCheckboxComponent;
...
const CHECKBOX_HOST_ATTRIBUTES = ['ls-checkbox', 'ls-checkbox--small'];

class LsCheckboxBase {
  public constructor(public elementRef: ElementRef) {}
}

const _LsCheckboxMixinBase: CanDisableCtor &
  typeof LsCheckboxBase = mixinDisabled(LsCheckboxBase);

@Component({
  selector: 'ls-checkbox, input[ls-checkbox]',
  exportAs: 'lsCheckbox',
...
export class LsCheckboxComponent
  extends _LsCheckboxMixinBase
  ...
  private _uniqueId: string = `ls-checkbox-${++nextUniqueId}`;
  ...
  @Output()
  public readonly change: EventEmitter<LsCheckboxChange> = new EventEmitter<LsCheckboxChange>();
  ...
  public constructor(
    ...
    elementRef.nativeElement.classList.add('ls-checkbox');
  }
  ...
  private _emitChangeEvent(): void {
    const event: LsCheckboxChange = new LsCheckboxChange();
    event.source = this;
